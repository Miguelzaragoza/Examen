...
class Cinema:
    ...
    def count_free_seats(self,rows_seats,total):
        ...
        """
        for lista in rows_seats:
            if self.__seating[lista[0]][lista[1]] is None:
                total = total + 1
        return total
#------------------------------------------- MAIN -----------------------------------------------
...
#El error pasa por que los parametros que se envian a la funcion estan mal escritos cuando la función los recibe la fila se canvia por la columna por tanto con poner bien los parametros funciona
...
seats = [(2,4), (3,1), (5,2)]
total = 0
#El error ocurre porque en ningun momento se recoje la instancia de la variable total por tanto en la función se le introduce un return total se recoge la instacia de total cuando se llama a la funcion y ya funciona
